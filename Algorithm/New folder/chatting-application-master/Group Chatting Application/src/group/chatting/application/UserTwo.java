...
public class UserTwo implements ActionListener, Runnable {
    ...
    UserTwo() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/g.png"));
        ...
        JLabel name = new JLabel("CSE-213 (A)");
        name.setBounds(110, 15, 110, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);

        JLabel status = new JLabel("Iteza,Nazmul,Zihad,Rabby,Tanzim,Abid");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            String outp = "<html><p>" + name + "</p><p>" + encryptedMessage + "</p></html>";
